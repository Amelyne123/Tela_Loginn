...
class Cadastro(BoxLayout):
    def __init__(self, **kwargs):
        ...
        self.add_widget(Label(text="CADASTRO", font_size=30, font_name='Times'))
        ...
        self.login_button = Button(text="Já Tenho Uma Conta!", font_name='Times', background_color=(0, 0, 1))
